...
class SoniTranslate(SoniTrCache):
    ...
    def batch_multilingual_media_conversion(self, *kwargs):
        ...
        edit_text_arg = kwargs[39]
        get_text_arg = kwargs[40]
    ...
    def multilingual_media_conversion(
        ...
        if auto_clone_voices:
            ...
            if max_speakers <= 1:
                max_speakers = 20
                logger.info("Auto-Clone: max_speakers set to 20 for dynamic speaker detection.")
        ...
        with gr.Tab(lg_conf["tab_translate"]):
            with gr.Row():
                with gr.Column():
                    ...
                    tts_voice12 = gr.Dropdown(
                        SoniTr.tts_info.tts_list(),
                        value="_XTTS_/AUTOMATIC.wav",
                        label="Speaker 13",
                        visible=False,
                        interactive=True,
                    )
                    tts_voice13 = gr.Dropdown(
                        SoniTr.tts_info.tts_list(),
                        value="_XTTS_/AUTOMATIC.wav",
                        label="Speaker 14",
                        visible=False,
